<?php
   ...
   {
     global $conMain;
     $query = mysqli_query($conMain, "SELECT DISTINCT {$type} FROM angajati");
     $text = '';
...
<html lang="en-US" dir="ltr">
   ...
   <body>
            ...
            <div class="content">
               ...
               <div class="card h-md-100 ecommerce-card-min-width">
                  <div class="card-body d-flex flex-column justify-content-end">
                     <h1 class="h1-title">Cartela Angajat</h1>
                    ...
                    <?php 
                      // $filtersPartOne = [ 
                      //     'user_email_field' => 'Gender', 
                      //     'last_name_first_name' => 'Full name' 
                      // ];

                      $filtersPartOne = [ 
                          'position_function' => 'Post / Funcție', 
                          'user_status_field' => 'Statusul (activ/inactiv)' 
                      ];
                              ...
                              <div class="modal-body modal-body-pacient">
                                 <form id="update-lines-upload_file" autocomplete="off">
                                    ...
                                    <div class="row mb-3">
                                       ...
                                       <div class="col-md-6">
                                          <label class="form-label">Post / Funcție</label>
                                          <select class="form-control" name="position_function" id="edit_position_function">
                                            ...
                                            <option value="Proiectant tehnic">Proiectant tehnic</option>
                                            <option value="Vizualizator">Vizualizator</option>
                                          </select>
                                       </div>
                                    </div>
                                    <div class="row mb-3">
                                       <div class="col-md-6">
                                          <label class="form-label">E-mail al utilizatorului</label>
                                          <input autocomplete="off" type="text" class="form-control" name="user_email_field" id="edit_user_email_field" placeholder="E-mail al utilizatorului" />
                                       </div>
                                       <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                       <div class="col-md-6">
                                          <label class="form-label">Preț per m² (pentru calcul salariu/proiect)</label>
                                          <input autocomplete="off" type="text" class="form-control" name="pret_m2" id="edit_pret_m2"/>
                                       </div>
                                       <div class="col-md-6">
                                          <label class="form-label">Statusul (activ/inactiv)</label>
                                          <select class="form-control" name="user_status_field" id="edit_user_status_field">
                              ...
                              <div class="modal-body modal-body-pacient">
                                 <form id="new-lines-upload_file" action="" autocomplete="off">
                                    ...
                                    <div class="row mb-3">
                                       ...
                                       <div class="col-md-6">
                                          <label class="form-label">Post / Funcție</label>
                                          <select class="form-control" name="position_function" id="position_function">
                                            <option value="">Select function</option>
                                            <option value="Designer">Designer</option>
                                            <option value="Arhitect">Arhitect</option>
                                            <option value="Video Editor">Video Editor</option>
                                    ...
                                    <div class="row mb-3">
                                       <div class="col-md-6">
                                          <label class="form-label">E-mail al utilizatorului</label>
                                          <input autocomplete="off" placeholder="E-mail al utilizatorului" type="text" class="form-control" name="user_email_field" id="user_email_field"/>
                                       </div>
                                       <div class="col-md-6">
                                          <label class="form-label">Număr de telefon</label>
                                    ...
                                    <div class="row mb-3">
                                       <div class="col-md-6">
                                          <label class="form-label">Preț per m² (pentru calcul salariu/proiect)</label>
                                          <input autocomplete="off" type="text" class="form-control" name="pret_m2" id="pret_m2"/>
                                       </div>
                                       <div class="col-md-6">
                                          <label class="form-label">Statusul (activ/inactiv)</label>
                                          <select class="form-control" name="user_status_field" id="user_status_field">
                                            <option value="Activ">Activ</option>
                                            <option value="Inactiv">Inactiv</option>
                                          </select>
                                       </div>
                                     ...
                                     <div class="form-check form-switch mb-3">
                                       <input class="form-check-input" type="checkbox" id="status_profile">
                                       <label class="form-check-label" for="status_profile">Creează profil</label>
                                     </div>

                                     <div id="create-profile-inputs" class="" style="display:none;">
                                       <div class="row mb-3">
                                          <div class="col-md-6">
                                            <input class="form-control" id="username_profile" type="text" placeholder="Nume utilizator" autocomplete="off">
                                          </div>
                                          <div class="col-md-6" id="level_profile" name="level_profile">
                                       ...
                                       <div class="row mb-3">
                                          <div class="col-md-6">
                                            <input class="form-control" id="password_profile" type="password" placeholder="Parola" autocomplete="off">
                                          </div>
                                          <div class="col-md-6">
                                            <input class="form-control" id="password_repeat_profile" type="password" placeholder="Repetă parola" autocomplete="off">
                                          </div>
                                       </div>
                                     </div>
      ...
      <script src="/crm/pages/packs/angajati/script.js" type="text/javascript"></script>
