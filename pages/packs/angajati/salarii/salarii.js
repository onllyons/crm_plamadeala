...
const apiBase = '/crm/pages/packs/angajati/salarii';

// 🔹 apoi iei id-ul din URL
...
if (slug) {
  ...
  const maybeId = parseInt(parts[parts.length - 1]);
  if (!isNaN(maybeId)) employeeId = maybeId;
}

// 🔹 abia acum poți apela funcția
if (employeeId) {
