<div id="employee-summary" class="mt-3"></div>
<div id="employee-payments" class="mt-3"></div>

<div class="modal fade" id="paymentModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <form id="paymentForm" class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Plată nouă</h5>
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" name="note" id="pm_note" rows="2"></textarea>
        </div>
        <div id="pm_feedback" class="small"></div>
      </div>
